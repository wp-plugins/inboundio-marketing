...
class Imp {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-imp-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-imp-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the Dashboard.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-imp-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-imp-public.php';

		$this->loader = new Imp_Loader();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Imp_Admin( $this->get_plugin_name(), $this->get_version() );
		...
		// loading admin side ajax requests
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Imp_Public( $this->get_plugin_name(), $this->get_version() );
